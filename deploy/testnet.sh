...
#secretcli tx compute execute secret156aue7vlx0lkc2n65x98u8kt6zsm8adpy3jklz '{"trigger_lucky_number":{"tier1": true, "tier2": true, "tier3": true, "entropy": 1234}}' --from test1 -y --gas 1500000 -b block
